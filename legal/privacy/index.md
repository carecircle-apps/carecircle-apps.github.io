...
- **Delete your account** via More → Security → Delete Account, or Account in family view. This removes your active sign-in identity, profile and memberships and starts local account cleanup. The service removes attributable messages, shift updates and AI learnings linked to your account, along with supported new records tracked as exclusively yours. Shared circles and other members’ contributions are preserved; older or collaboratively edited records can remain, including names or information written into shared text. Other members’ accounts and contributions are not deleted. Apple subscriptions must be managed separately in Apple Subscriptions.
...
- **Care circle data:** the current account-deletion flow removes attributable account contributions and supported exclusively authored records. Older records without reliable edit history and collaboratively edited care history can remain for other members. Removing an account link does not remove names or health information written into shared text. We do not currently apply a fixed automatic age-based deletion period to those shared records. Contact carecircle89@icloud.com to request removal of personal information that remains; we will assess the request and explain its outcome under applicable law. Leaving a circle and signing out are separate actions.
